...
const Ticket = ({ ticketId }: { ticketId: Id<"tickets"> }) => {
  const ticket = useQuery(api.queries.tickets.getTicketWithDetails,{ticketId});
  const user = useQuery(api.queries.users.getUserById,{
            ...
            <div className="flex items-center text-gray-600">
              ...
              <div>
                ...
                <p className="font-medium">
                  {new Date(
                    ticket.event?.eventDate as number
                  ).toLocaleDateString()}
                </p>
              </div>
            </div>
